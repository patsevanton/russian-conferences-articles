Я Александр Валялкин. Работаю в компании VertaMedia. Я для наших нужд разработал fasthttp, который включает себя реализацию штапик клиента и сервера который работает много быстрее чем стандартный этаж тебе пока избу postage т.п.
