...
Так же как и Fasthttp.Client у Fasthttp.HostClient можно ограничивать количество открытых подключений на каждый из Backend серверов. эта пища который отсутствует в наш цепи и также эта фича отсутствует в engine и все стандартно он есть только в платном же насколько я знаю его 
