...
Ограничиваем connection pool. Кода здесь нет, потому что он слишком большой для того чтобы поместиться на один слайд. Желающие могут посмотреть реализацию этой функции на http://github.com.
