...
Если вы опытный бэкендер, вам без разницы на чём писать, на Python, Ruben, elixir, Go, Java. Если это не C++, то точно на чём угодно.
...
Ответ: СPython. По первому бенчмарку, который http.  Там PyPy ипользовался. Он не сильно лучше. Где-то хуже, где-то лучше.
