...
Следующий пример. Обработка статус кода, который внезапно не таймаут. Нам сервер ответил корректно 500 http code. Это меня каждый раз удивляет в http либах. Ответ http code 500 считается корректным, а 400 это точно корректный. 
