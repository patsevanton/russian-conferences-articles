...
Код Go простой. Его тяжело сделать по-разному. И это замечательно. В go действительно реализован едииный хороший формат. И поскольку он реализован, вы с первого раза считываете паттерны, а потом просто читаете код с листа быстро. Исходя из этого скорость разработки сравнимая.
