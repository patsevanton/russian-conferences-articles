...
Ответ: Более подроный ответ в моих докладов про анкор modeling и аналитическое хранилище. У нас хранилище автоматически генерируется по описанию сущности, связи, атрибута. И эта информация напрямую льется. Сложнее с источниками, потому что эта сущность поступает из разных источников. Путь, по которому прилетае сущность, не всегда допускает автоматический парсинг из-за промежуточных буферов. То есть сущности автоматические. Пути заливки сущностей в полуручном режиме.
