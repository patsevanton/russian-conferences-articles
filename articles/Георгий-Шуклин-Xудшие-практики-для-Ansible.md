...
*Это про <font color="red">гольф</font>.*
...
![](https://habrastorage.org/webt/ue/mx/pt/uemxptedozxnlczcikpobxgfrrw.png)
        Еще одна причина популярности Ansible – это сетевые устройства. Оказалось, что модель работы Ansible идеально ложится на конфигурирование сетевых устройств с API, потому что у Ansible отсутствует понятие агента, клиента, какого-то кода, исполнявшегося со стороны конфигурируемого устройства. 

Вместо этого Ansible приходит на сервер, на сетевое устройство и вносит туда изменение. И в сетевом оборудовании вы можете сделать изменение. 
...
- Такую функцию удобно анализировать на наличие или отсутствие ошибок, на сохранение <font color="red">инвариантов</font>. 
