...
Я директор по разработке в компании LifeStreet, которая использует ClickHouse. Кроме того, я основатель Altinity. Это партнер Яндекса, который продвигает ClickHouse  и помогает Яндексу сделать из этого какую-то успешную штуку. Поэтому я немножко знаю о ClickHouse  и  готов с удовольствием делиться этими знаниями . 
...
Чуть менее известно,  в каких компаниях и каким образом он используется. 
