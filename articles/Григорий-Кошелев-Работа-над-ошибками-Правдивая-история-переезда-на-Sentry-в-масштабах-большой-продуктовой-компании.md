...
Григорий-Кошелев-Работа-над-ошибками-Правдивая-история-переезда-на-Sentry-в-масштабах-большой-продуктовой-компании.md
...
![](https://habrastorage.org/webt/if/kx/8b/ifkx8bb6fcbilzmazuks0rsqqui.gif)
...
![](https://habrastorage.org/webt/k5/qp/m9/k5qpm9bisps-du1xtpy0kjngtsa.gif)
...
![](https://habrastorage.org/webt/q9/k6/zq/q9k6zqknkbjorf-sufgka5duht8.gif)
...
![](https://habrastorage.org/webt/wi/fe/fk/wifefk8dkp3o4rpnlbwdbbrs7z8.gif)
...
![](https://habrastorage.org/webt/sb/aa/yp/sbaayp38ylnmjvjhwdlqdg44xg4.gif)
...
Я бы сделал отсылку к двум методологиям. Это [USE](http://www.brendangregg.com/usemethod.html)-методология и RED-методология. Обе эти методологии содержат метрики по ошибкам, которые позволяют нам понять по типам ошибок, по их частоте возникновения, по количеству. Эти метрики позволят нам как-то ретроспективно (не обязательно ночью вставать и чинить) посмотреть, в чем у нас конкретно проблемы, какие настройки надо потюнить и, может быть, исправить какие-то баги.
...
![](https://habrastorage.org/webt/bt/4j/ki/bt4jkicj8bepl56cmdyepcj0iny.gif)
