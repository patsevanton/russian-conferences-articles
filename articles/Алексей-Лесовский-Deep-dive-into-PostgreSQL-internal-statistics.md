...
*Дорогие друзья, сейчас будет последний доклад из утреннего блока технических докладов по* *PostgreSQL**. Рассказывать будет мой коллега Алексей Лесовский про то, где у* *PostgreSQL* *смотреть, где и какой* *performance**. Когда что-то происходит плохо, нужно поглядеть, какие средства диагностики. Но не просто их поглядеть, а еще и правильно их интерпретировать и смотреть в некой системе. Алексей Лесовский знает об этом намного лучше других и может рассказать. Предоставляю слово Алексею.*
...
- 
- И есть неофициальные contrbs. Они не поставляются в стандартной поставке PostgreSQL. Их нужно либо скомпилировать, либо подсунуть в библиотеку. Варианты могут быть самые разные, в зависимости от того, что придумал разработчик этого неофициального contrib’а.  
