...
P.S Вышла новая версия [0.2.15](https://github.com/wal-g/wal-g/releases/tag/v0.2.15), в которой можно использовать файл конфигурации .walg.json, который по умолчанию находится в домашней директории postgres. Можно отказаться от bash скриптов. Пример .walg.json находится в этом issue https://github.com/wal-g/wal-g/issues/545
