...
- Расскажу о проектах, которые у нас планируются. Расскажу о [PgBouncer](https://www.pgbouncer.org/).  
- О [Postgres Checkup](https://gitlab.com/postgres-ai/postgres-checkup).
...
А также инструменты, которые мы разработали для поддержки производительности и доступности базы данных – [Postgres-Checkup](https://gitlab.com/postgres-ai/postgres-checkup) и [Joe bot](https://gitlab.com/postgres-ai/joe), например. 
...
![](https://habrastorage.org/webt/a-/eq/6z/a-eq6zizd1sy_rhr2ty4ucsbxmm.png)
