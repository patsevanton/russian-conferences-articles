...
И тоже самое мы делаем для всех других метрик. Мы видим, что, допустим, в первой группе работа с кэшом операционной системы составляет 7 % от всей работы с кэшем операционной системы. 
