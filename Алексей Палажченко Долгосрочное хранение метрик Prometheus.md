...
Важно понимать, что это не SaaS. У нас нет production'а. Наш production находится у наших клиентов. На нем экспериментировать не очень хорошо. У нас есть ближайшая вещь, которую можно было бы назвать production - это pmmdemo.percona.com. Cейчас он не работает. Кто может предположить почему pmmdemo.percona.com не работает? Из-за GDPR: сейчас нам пришлось его выключить.
