...
Все side-car соединенные между собой и между мастером кастомным API, который через gRPC. Там есть репликация, есть перешардирование. Там сложная архитектура. 
