...
Если скрипты выполняются корректно и не возвращает код ошибки то соответственно то даже пианино сне то соответственно система переходит ко второй стадии станет тепло и 
