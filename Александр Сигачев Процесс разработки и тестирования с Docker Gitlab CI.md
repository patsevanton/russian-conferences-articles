...
Если графически изобразить, то получается что клиент это наш браузер или какой-то инструмент которым мы осуществляем доброты посредстве на нашем балансе ru
