Если у вас стоит задача сделать отказоустойчивый кластер совместимый с AWS S3 для тестирования или небольшой нагрузки, или по каким-то причинам вам не подходит Ceph, то стоит попробовать запустить Minio в распределенном режиме.
