...
P.S. №2 Ошибки, исправления по статье, добавления в сводную таблицу можно сделать через [Pull request](https://github.com/patsevanton/russian-conferences-articles/blob/master/Андрей_Сальников_Инструменты_создания_бэкапов_PostgreSQL.md)  

P.S. №3 Для установка wal-g используя rpm вы можете воспользоваться моим репозиторием: [Github](https://github.com/patsevanton/wal-g-rpm), [Fedora COPR](https://copr.fedorainfracloud.org/coprs/antonpatsev/wal-g/).

P.S. №4 Как сделать в создание и хранение в S3 полный бекап и инкрементальный бекап, а на ленту сохранение только полного бекапа? Если есть идеи, подскажите в коментариях или в личку.
...
P.S. №5 Телеграм канал PostgreSQL: https://t.me/pgsql
