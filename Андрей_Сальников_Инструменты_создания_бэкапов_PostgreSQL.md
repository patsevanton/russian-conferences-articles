...
P.S. №3 Wal-g нуждается в волонтерах, которые бы обновили документацию.

P.S. №4 Для установка wal-g используя rpm вы можете воспользоваться моим репозиторием: [Github](https://github.com/patsevanton/wal-g-rpm), [Fedora COPR](https://copr.fedorainfracloud.org/coprs/antonpatsev/wal-g/).
