...
С Azure и так далее только wal-e. Google Cloud только wal-e, вот. 
Кто-нибудь, кстати, пользует Azure, Google Cloud для своих баз данных. Да, у вас без вариантов ребята. Если вы хотите их облачными хранилищами пользоваться. 
