...
P.S. №1 Сделал сводную таблицу с инстрментами кроме pg_dump, pg_basebackup.
...
P.S. №3 Для установка wal-g используя rpm можете воспользоваться моим репозиторием: [Github](https://github.com/patsevanton/wal-g-rpm), [Fedora COPR](https://copr.fedorainfracloud.org/coprs/antonpatsev/wal-g/).

Опрос: Каким инструментов для бекапов вы пользуетесь?

P.S. №Телеграм канал PostgreSQL: https://t.me/pgsql
